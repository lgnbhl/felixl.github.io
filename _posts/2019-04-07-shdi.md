...
excerpt: An interactive exploration of the subnational human development index over the years
permalink: /shdi/
...
![](/images/screenshot_shdi-app.png)
...
As explained by the [UNDP](http://hdr.undp.org/en/content/human-development-index-hdi), *the Human Development Index (HDI) is a summary measure of average achievement in key dimensions of human development: a long and healthy life, being knowledgeable and have a decent standard of living*. In other words, it is people and their capabilites that should be the criteria for assessing the development of a country, not economic growth alone.
...
<iframe seamless src="https://lgnbhl.shinyapps.io/shdi/" width="100%" height="500" frameborder="0"></iframe>

Feel free to play with the Web app to discover insights.
...
<iframe seamless src="output/p1.html" width="100%" height="400" frameborder="0"></iframe>
...
<iframe seamless src="output/p2.html" width="100%" height="400" frameborder="0"></iframe>
...
<iframe seamless src="output/p3.html" width="100%" height="400" frameborder="0"></iframe>
...
<iframe seamless src="output/p4.html" width="100%" height="400" frameborder="0"></iframe>
...
<iframe seamless src="output/p5.html" width="100%" height="400" frameborder="0"></iframe>
...
*[UNDP]: United Nations Development Programme{:.mega-big}
*[HDI]: Human Development Index{:.mega-big}
*[SHDI]: Subnational Human Development Index{:.mega-big}
*[IQR]: Interquartile Range{:.mega-big}
