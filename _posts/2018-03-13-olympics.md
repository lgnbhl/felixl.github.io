...
We will then show how to use simple models for exploratory data analysis.
...
However, maybe countries having won less than 3 medals have often a HDI lower than 0.86? It is then time to try a binary logistic regression.
