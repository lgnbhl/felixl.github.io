...
Before exploring these questions, we firstly need to choose a metric to classify the participating nations from the richer to the poorer. As Norway, Germany and Canada are the most medaled countries of the 2018 Winter Olympics, the Human Development Index is clearly a better choice than the GDP.
...
In this article, we will thus show to show how to use simple models for exploratory data analysis.
