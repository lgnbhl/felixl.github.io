...
Our objective is simply to know how much the Human Development Index can explain the number of medals won by each country during the Winter Olympics Games. This article thus wants to show how to use simple models (linear and logistic regressions) for exploratory data analysis.
