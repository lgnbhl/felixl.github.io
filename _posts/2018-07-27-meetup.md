...
I obviously had to make my slides using R. Afer some research, I discovered the `revealjs` package, which allows to create [reveal.js](https://revealjs.com/) presentations using R Markdown. I was able to produce this presentation writing only two lines of code by slide. Check it out\!

<iframe seamless src="/images/meetup_slides.html" width="100%" height="400" frameborder="1"></iframe><br>

As always, I try to make work fully reproductible. To reproduce my slides, simply run the R Markdown file below into RStudio. For more information, you can read the [chapter 8](https://bookdown.org/yihui/rmarkdown/revealjs.html) of *R Markdown: The Ultimate Guide*. 
