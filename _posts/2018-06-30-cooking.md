...
Another way of comparing the variation of the number of ingredients per
recipe by cuisine is to calculate the [coefficient of variation](https://en.wikipedia.org/wiki/Coefficient_of_variation) (CV)[^1] of each cuisine.
...
We see that the Brazilian cuisine have much more variation (CV of 58.4%)
than the Chinese cuisine (CV of 33.7%) relative to their means.

[^1]: the sample standard deviation should not be used as the mean of the ingredients by recipes varies according to the cuisine.
...
<iframe seamless src="/images/dt_cuisine.html" width="100%" height="400" frameborder="0"></iframe>
...
{tidytext}. We will performe feature reduction by removing the less frequent words.
