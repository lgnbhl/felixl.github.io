---
layout: single
title: Using Recipe Ingredients to Categorize the Cuisine
excerpt: Building classification models with XGBoost and h2o AutoML in a tidy way.
permalink: /cooking/
...
To work in a tidy way, we will `unnest` the variable `ingredients`. We will also make some cleaning and join the `train`
and `test` datasets.
...
<p><iframe markdown="span" seamless src="/images/DTdatatable.html" width="100%" height="600px" frameborder="1"></iframe></p>
