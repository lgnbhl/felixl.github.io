...
<details><summary markdown="span"><button class="btn btn--light">Show code</button></summary>
...
<iframe markdown="span" seamless src="/images/js_leaflet_map.html" width="100%" height="400" frameborder="0"></iframe>
