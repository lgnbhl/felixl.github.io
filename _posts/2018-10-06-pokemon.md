...
<form action="https://protonmail.us20.list-manage.com/subscribe/post?u=7945317aa7643e6d8a0fa8c04&amp;id=a948336df0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	
	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Email address" required>
    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_7945317aa7643e6d8a0fa8c04_a948336df0" tabindex="-1" value=""></div>
    <div class="clear"><input type="submit" value="Subscribe via e-mail" name="subscribe" id="mc-embedded-subscribe" class="btn btn-submit btn--danger w-75"></div>
    </div>
</form>
</div>
